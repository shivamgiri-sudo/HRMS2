...
| 4 | Frontend `npm install` not completing | build environment | Running in background | Pending | ⏳ IN PROGRESS |
| 5 | Frontend typecheck | frontend | Pending install | Pending | ⏳ PENDING |
| 6 | Frontend build | frontend | Pending install | Pending | ⏳ PENDING |

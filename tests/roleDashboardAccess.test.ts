...
} from "../src/pages/dashboards/roleDashboardAccess";
import {
  asNumber,
  metricDetail,
  percent,
} from "../src/pages/dashboards/reference-dashboard-model";
...
describe("canAccessRoleDashboard", () => {
  ...
  it("rejects direct navigation outside the assigned role", () => {

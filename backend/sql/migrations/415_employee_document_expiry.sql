...
ALTER TABLE employee_documents
  ADD COLUMN expiry_date        DATE         NULL   AFTER verified,
  ADD COLUMN reminder_sent_at   DATETIME     NULL   AFTER expiry_date,
  ADD COLUMN issuing_authority  VARCHAR(255) NULL   AFTER reminder_sent_at,
  ADD COLUMN document_number    VARCHAR(100) NULL   AFTER issuing_authority;

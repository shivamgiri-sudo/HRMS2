-- backend/sql/migrations/438_employee_retention_recommendation.sql
-- Creates employee_retention_recommendation to store AI-generated retention
-- actions per employee: risk tier, prediction score, recommended actions,
-- and outcome tracking (retained / exited / pending).
...
CREATE TABLE IF NOT EXISTS employee_retention_recommendation (
  ...
  recommendations   JSON              NOT NULL COMMENT 'Array of {priority, owner, action, reason, triggered_by[]}',

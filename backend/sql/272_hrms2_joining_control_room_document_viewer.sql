...
-- Guarded on the TABLE as well as the column, 2026-08-03. candidate_onboarding_document has no CREATE TABLE
-- anywhere in sql/, and a column count of zero is also what a missing table looks like,
-- so these guards fired ALTERs against a table that is not there. Guarding lets the
-- build proceed; it does not give the table a definition.
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN name_match_status ENUM(''pending'',''matched'',''mismatch'',''not_applicable'') NOT NULL DEFAULT ''pending'' AFTER document_status', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'name_match_status');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN verified_by CHAR(36) NULL AFTER name_match_status', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'verified_by');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN verified_at DATETIME NULL AFTER verified_by', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'verified_at');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN verification_remarks TEXT NULL AFTER verified_at', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'verification_remarks');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN rejected_by CHAR(36) NULL AFTER verification_remarks', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'rejected_by');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN rejected_at DATETIME NULL AFTER rejected_by', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'rejected_at');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql = (SELECT IF(COUNT(*) = 0 AND (SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document') > 0, 'ALTER TABLE candidate_onboarding_document ADD COLUMN rejection_reason TEXT NULL AFTER rejected_at', 'SELECT 1') FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'candidate_onboarding_document' AND COLUMN_NAME = 'rejection_reason');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;

...
-- branch_master.id is VARCHAR(36) utf8mb4_unicode_ci in the canonical schema;
-- the referencing column must match its type and collation exactly.
...
-- employees.id is VARCHAR(36), while biometric_device_master.id is CHAR(36).

...
ALTER TABLE helpdesk_ticket
  ...
  ADD COLUMN breached_flag TINYINT(1) NOT NULL DEFAULT 0,
  ADD COLUMN escalation_level INT NOT NULL DEFAULT 0,
  ADD COLUMN assigned_department VARCHAR(100) NULL,
  ADD COLUMN root_cause VARCHAR(255) NULL,
  ADD COLUMN closure_rating INT NULL,
  ADD COLUMN reopened_count INT NOT NULL DEFAULT 0,
  ADD COLUMN impact_type VARCHAR(100) NULL,
  ADD COLUMN employee_blocked TINYINT(1) NOT NULL DEFAULT 0,
  ADD COLUMN productivity_impact TINYINT(1) NOT NULL DEFAULT 0,
  ADD COLUMN payroll_impact TINYINT(1) NOT NULL DEFAULT 0,
  ADD COLUMN system_access_impact TINYINT(1) NOT NULL DEFAULT 0;
...
ALTER TABLE grievance
  ...
  ADD COLUMN escalation_level INT NOT NULL DEFAULT 0,
  ADD COLUMN confidentiality_level VARCHAR(30) NOT NULL DEFAULT 'restricted',
  ADD COLUMN anti_retaliation_flag TINYINT(1) NOT NULL DEFAULT 1,

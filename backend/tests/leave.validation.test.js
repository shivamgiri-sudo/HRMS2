...
import { createLeaveTypeSchema, leaveRequestSchema, reviewLeaveSchema, leaveRequestFiltersSchema, createHolidaySchema, } from "../src/modules/leave/leave.validation.js";
...
describe("leaveRequestSchema", () => {
    ...
    it("rejects toDate before fromDate", () => {
        expect(() => leaveRequestSchema.parse({ ...valid, fromDate: "2026-06-05", toDate: "2026-06-01" })).toThrow();
    });

...
export const PROCESS_KPI_REGISTRY: ProcessKpiSet[] = [
  {
    ...
    metrics: [
      ...
      { metricKey: "abc_prepaid_pct", label: "Prepaid Target %", family: "rate", unit: "percent", target: 85, direction: "higher_is_better", lobLabel: "ABC", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE + " (COD_SHARE is tracked; prepaid = 100 − COD_SHARE is not computed anywhere)." },
      ...
      { metricKey: "upgrade_prepaid_pct", label: "Prepaid Target %", family: "rate", unit: "percent", target: 85, direction: "higher_is_better", lobLabel: "Upgrade", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
      ...
      { metricKey: "upgrade_net_revenue", label: "Net Revenue", family: "volume", unit: "currency", target: 329095, direction: "higher_is_better", lobLabel: "Upgrade", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
      { metricKey: "upgrade_roi", label: "ROI", family: "roi", unit: "ratio", target: 5, direction: "higher_is_better", lobLabel: "Upgrade", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
    ],
  },
  {
    ...
    metrics: [
      { metricKey: "email_closure_hr", label: "Email Closure", family: "duration", unit: "seconds", target: 48 * 3600, direction: "lower_is_better", lobLabel: "Email", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE + " (no email-ticketing TAT metric exists in kpi_metric_master)." },
      { metricKey: "mo_email_closure_hr", label: "Email Closure", family: "duration", unit: "seconds", target: 48 * 3600, direction: "lower_is_better", lobLabel: "MO", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
      ...
      { metricKey: "abc_roi", label: "ROI", family: "roi", unit: "ratio", target: 11.67, direction: "higher_is_better", lobLabel: "ABC", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
      { metricKey: "reshipment_sec", label: "Reshipment", family: "duration", unit: "seconds", target: 3600, direction: "lower_is_better", lobLabel: "RTO", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE + " (no returns/reshipment TAT metric exists in kpi_metric_master)." },
    ],
  },
  {
  ...
  },
  {
    ...
    projectName: "GS1",
    metrics: [
      { metricKey: "gs1_email_tat_sec", label: "Email — response w/ resolution", family: "duration", unit: "seconds", target: 3600, direction: "lower_is_better", lobLabel: "Email", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE + " (no email TAT metric exists)." },
      { metricKey: "gs1_datacart_tat_sec", label: "Data Cart — download & update", family: "duration", unit: "seconds", target: 3600, direction: "lower_is_better", lobLabel: "Data Cart", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
      { metricKey: "gs1_approval_tat_sec", label: "Approval — verify product data", family: "duration", unit: "seconds", target: 4 * 3600, direction: "lower_is_better", lobLabel: "Approval", kpiMetricCode: null, notTrackedNote: NO_METRIC_CODE },
    ],
  },
];

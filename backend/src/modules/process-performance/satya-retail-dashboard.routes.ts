...
router.get("/satya-retail-dashboard", requireRole(...VIEWER_ROLES), h(async (_req, res) => {
  const data = await getSatyaRetailDashboard();
  res.json({ success: true, data });
}));

export { router as satyaRetailDashboardRouter };

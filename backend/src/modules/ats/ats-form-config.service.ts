...
const DEFAULT_FIELDS = [
  ...
  { k:'branch',           lb:'Branch',                   t:'select', ic:'🏢', ph:null, ok:'branchOptions',         section:'Job Details', visible:true, required:true,  sort_order:8  },
  ...
  { k:'roleApplied',      lb:'Role Applied',             t:'select', ic:'🗂️', ph:null, ok:'roleOptions',           section:'Job Details', visible:true, required:true,  sort_order:10 },

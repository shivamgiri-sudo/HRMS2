...
const DEFAULT_FIELDS = [
  ...
  { k:'branch',           lb:'Branch',                   t:'select', ic:'🏢', ph:null, ok:'branchOptions',         section:'Job Details', visible:true, required:true,  sort_order:9  },
  { k:'recruiterName',    lb:'Recruiter Name',           t:'select', ic:'🤝', ph:null, ok:'recruiterOptions',      section:'Job Details', visible:true, required:true,  sort_order:10 },

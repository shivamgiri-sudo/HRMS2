...
router.get('/form-config/bootstrap', h(async (_req: Request, res: Response) => {
...
router.get('/form-config/recruiters-by-branch', h(async (req: Request, res: Response) => {
...
router.get('/form-config', requireAuth, requireRole('admin', 'hr'), h(async (_req: AuthenticatedRequest, res: Response) => {
  const configs = await svc.getAllConfigs();
  res.json({ success: true, data: configs });
}));

router.put('/form-config/fields', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/form-config/:key', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
...
router.get('/recruiters', requireAuth, requireRole('admin', 'hr'), h(async (_req: AuthenticatedRequest, res: Response) => {
  const data = await svc.listRecruiters();
  res.json({ success: true, data });
}));

router.post('/recruiters', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
  const { name } = req.body;
...
router.patch('/recruiters/:id', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
  const { name, active_status, sort_order } = req.body;
  await svc.updateRecruiter(req.params.id, { name, active_status, sort_order });
  res.json({ success: true });
}));

router.delete('/recruiters/:id', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
  await svc.deleteRecruiter(req.params.id);
  res.json({ success: true });
}));

// Branch Alias Management
router.get('/branch-aliases', requireAuth, requireRole('admin', 'hr'), h(async (_req: AuthenticatedRequest, res: Response) => {
  const data = await svc.listBranchAliases();
  res.json({ success: true, data });
}));

router.post('/branch-aliases', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
...
router.patch('/branch-aliases/:id', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {
...
router.delete('/branch-aliases/:id', requireAuth, requireRole('admin', 'hr'), h(async (req: AuthenticatedRequest, res: Response) => {

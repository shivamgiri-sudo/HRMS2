...
export const REPORT_CATALOG: ReportDefinition[] = [
...

  {
    ...
    primaryKey: ["emp_code"],
    columns: [
      { key: "sno", label: "S.No", format: "number", width: 60, align: "right" },
      { key: "emp_code", label: "Emp Code", format: "text", width: 100 },
      { key: "bio_code", label: "Biometric Code", format: "text", width: 110 },
      { key: "emp_name", label: "Employee Name", format: "text", width: 180 },
      { key: "department", label: "Department", format: "text", width: 120 },
      { key: "designation", label: "Designation", format: "text", width: 120 },
      { key: "cost_center", label: "Cost Centre", format: "text", width: 120 },
      { key: "emp_location", label: "Branch", format: "text", width: 120 },
      { key: "billable", label: "Billable", format: "text", width: 80 },
      { key: "present_count", label: "Present Days", format: "number", width: 100, align: "right" },
      { key: "absent_count", label: "Absent Days", format: "number", width: 100, align: "right" },
      // day_1..day_N (attendance status code per calendar day) are generated
      // dynamically per month length and rendered as additional columns by
      // the export/viewer, not listed individually here.
    ],
    filters: [F_MONTH, F_BRANCH, F_PROCESS],
    viewRoles: ROLES_WFM,
    exportRoles: ROLES_HR_ADMIN,

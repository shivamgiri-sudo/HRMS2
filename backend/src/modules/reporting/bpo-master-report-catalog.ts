...
export const BPO_MASTER_REPORTS: BpoMasterReportDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      c("INCENTIVE_AMOUNT", "masked", { sensitive: true }), c("DISCIPLINARY_CASE_COUNT", "masked", { sensitive: true }),
      c("GRIEVANCE_CASE_COUNT", "masked", { sensitive: true }), c("MANAGER_REMARKS", "masked", { sensitive: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      c("TIME_ZONE"), c("SERVICE_TYPE"), c("BILLING_MODEL"), c("RATE_CARD_VALUE", "masked", { sensitive: true }),
      ...
      c("REVENUE_RECOGNISED", "masked", { sensitive: true }), c("SERVICE_CREDIT_OR_PENALTY", "masked", { sensitive: true }),
      c("DIRECT_COST", "masked", { sensitive: true }), c("GROSS_MARGIN", "masked", { sensitive: true }),
      c("GROSS_MARGIN_PERCENTAGE", "masked", { sensitive: true }), c("INVOICE_STATUS", "status"),
  ...
  },
  {
    ...
    columns: [
      ...IDENTITY,
      c("GENDER"), c("DATE_OF_BIRTH", "masked", { sensitive: true }), c("AGE_YEARS", "masked", { sensitive: true }),
      c("OFFICIAL_EMAIL", "email"), c("PERSONAL_EMAIL", "masked", { sensitive: true }), c("MOBILE_NUMBER", "masked", { sensitive: true }),
      c("CURRENT_ADDRESS", "masked", { sensitive: true }), c("PERMANENT_ADDRESS", "masked", { sensitive: true }),
      c("EMERGENCY_CONTACT_NAME", "masked", { sensitive: true }), c("EMERGENCY_CONTACT_NUMBER", "masked", { sensitive: true }),
      ...
      c("AADHAAR_STATUS", "masked", { sensitive: true }), c("PAN_STATUS", "masked", { sensitive: true }),
      c("UAN_STATUS", "masked", { sensitive: true }), c("ESIC_STATUS", "masked", { sensitive: true }),
      c("BANK_VERIFICATION_STATUS", "masked", { sensitive: true }), c("MANDATORY_DOCUMENT_COUNT", "number"),
      c("VERIFIED_DOCUMENT_COUNT", "number"), c("MISSING_DOCUMENT_COUNT", "number"), c("EXPIRING_DOCUMENT_COUNT", "number"),
      c("BGV_STATUS", "masked", { sensitive: true }), c("BGV_RISK_LEVEL", "masked", { sensitive: true }),
      c("BGV_COMPLETED_DATE", "masked", { sensitive: true }), c("ONBOARDING_COMPLETION_PERCENTAGE", "percentage"),
      ...
      c("REHIRE_ELIGIBILITY", "masked", { sensitive: true }), c("HR_DATA_COMPLETENESS_PERCENTAGE", "percentage"),
  ...
  },
  {
    ...
    columns: [
      ...
      c("OVERTIME_HOURS", "number"), c("BASIC_PAY", "masked", { sensitive: true }), c("HRA", "masked", { sensitive: true }),
      c("SPECIAL_ALLOWANCE", "masked", { sensitive: true }), c("CONVEYANCE_ALLOWANCE", "masked", { sensitive: true }),
      c("OTHER_ALLOWANCE", "masked", { sensitive: true }), c("VARIABLE_PAY", "masked", { sensitive: true }),
      c("INCENTIVE_AMOUNT", "masked", { sensitive: true }), c("OVERTIME_AMOUNT", "masked", { sensitive: true }),
      c("ARREAR_AMOUNT", "masked", { sensitive: true }), c("REIMBURSEMENT_AMOUNT", "masked", { sensitive: true }),
      c("GROSS_EARNINGS", "masked", { sensitive: true }), c("LWP_DEDUCTION", "masked", { sensitive: true }),
      c("PF_EMPLOYEE", "masked", { sensitive: true }), c("PF_EMPLOYER", "masked", { sensitive: true }),
      c("ESIC_EMPLOYEE", "masked", { sensitive: true }), c("ESIC_EMPLOYER", "masked", { sensitive: true }),
      c("PROFESSIONAL_TAX", "masked", { sensitive: true }), c("TDS", "masked", { sensitive: true }),
      c("LOAN_DEDUCTION", "masked", { sensitive: true }), c("ADVANCE_DEDUCTION", "masked", { sensitive: true }),
      c("OTHER_DEDUCTION", "masked", { sensitive: true }), c("TOTAL_DEDUCTIONS", "masked", { sensitive: true }),
      c("NET_PAY", "masked", { sensitive: true }), c("CTC_MONTHLY", "masked", { sensitive: true }),
      ...
      c("IFSC_CODE", "masked", { sensitive: true }), c("BANK_VERIFICATION_STATUS", "masked", { sensitive: true }),
      ...
      c("DISBURSAL_STATUS", "status"), c("DISBURSAL_DATE", "date"), c("UTR_REFERENCE", "masked", { sensitive: true }),
      c("PAYROLL_VARIANCE_AMOUNT", "masked", { sensitive: true }), c("PAYROLL_VARIANCE_PERCENTAGE", "percentage"),
  ...
  },
  {
    ...
    columns: [
      ...
      c("COST_CENTRE"), c("BILLING_MODEL"), c("CURRENCY"), c("RATE_CARD_VALUE", "masked", { sensitive: true }),
      c("PLANNED_BILLING_UNITS", "number"), c("ACTUAL_BILLING_UNITS", "number"), c("BILLING_UNIT_VARIANCE", "number"),
      c("PLANNED_REVENUE", "masked", { sensitive: true }), c("EARNED_REVENUE", "masked", { sensitive: true }), c("REVENUE_RECOGNISED", "masked", { sensitive: true }),
      c("UNBILLED_REVENUE", "masked", { sensitive: true }), c("DEFERRED_REVENUE", "masked", { sensitive: true }),
      c("INVOICE_AMOUNT", "masked", { sensitive: true }), c("INVOICE_STATUS", "status"),
      c("COLLECTION_AMOUNT", "masked", { sensitive: true }), c("OUTSTANDING_RECEIVABLE", "masked", { sensitive: true }),
      c("COLLECTION_DSO_DAYS", "number"), c("PRODUCTIVE_HEADCOUNT", "number"), c("BILLED_FTE", "number"),
      c("SEAT_UTILISATION_PERCENTAGE", "percentage"), c("PAYROLL_COST", "masked", { sensitive: true }),
      c("INCENTIVE_COST", "masked", { sensitive: true }), c("OVERTIME_COST", "masked", { sensitive: true }),
      c("TRAINING_COST", "masked", { sensitive: true }), c("RECRUITMENT_COST", "masked", { sensitive: true }),
      c("FACILITY_COST", "masked", { sensitive: true }), c("TECHNOLOGY_COST", "masked", { sensitive: true }),
      c("VENDOR_COST", "masked", { sensitive: true }), c("OTHER_DIRECT_COST", "masked", { sensitive: true }),
      c("DIRECT_COST_TOTAL", "masked", { sensitive: true }), c("OVERHEAD_ALLOCATION", "masked", { sensitive: true }),
      c("TOTAL_COST", "masked", { sensitive: true }), c("GROSS_PROFIT", "masked", { sensitive: true }),
      c("GROSS_MARGIN_PERCENTAGE", "masked", { sensitive: true }), c("EBITDA", "masked", { sensitive: true }),
      c("EBITDA_CONTRIBUTION", "masked", { sensitive: true }),
      c("EBITDA_MARGIN_PERCENTAGE", "masked", { sensitive: true }), c("BUDGET_AMOUNT", "masked", { sensitive: true }),
      c("BUDGET_VARIANCE", "masked", { sensitive: true }), c("BUDGET_VARIANCE_PERCENTAGE", "percentage"),
      c("GRN_GROSS_AMOUNT", "masked", { sensitive: true }), c("PNL_RECOGNISED_COST", "masked", { sensitive: true }),
      c("VENDOR_PAYABLE", "masked", { sensitive: true }), c("CASH_PAID", "masked", { sensitive: true }),
      c("OUTSTANDING_PAYABLE", "masked", { sensitive: true }), c("SERVICE_CREDIT_OR_PENALTY", "masked", { sensitive: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      c("FINANCIAL_IMPACT_AMOUNT", "masked", { sensitive: true }), c("REWORK_REQUIRED_FLAG", "boolean"),
  ...
  },
  {
    ...
    columns: [
      ...
      c("MOBILE_NUMBER", "masked", { sensitive: true }), c("EMAIL_ADDRESS", "masked", { sensitive: true }),
      ...
      c("OFFER_STATUS", "status"), c("OFFER_DATE", "date"), c("OFFERED_CTC", "masked", { sensitive: true }),
      ...
      c("DOCUMENT_COMPLETION_PERCENTAGE", "percentage"), c("BGV_STATUS", "masked", { sensitive: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      c("RETURN_CONDITION", "status"), c("DAMAGE_OR_LOSS_FLAG", "boolean"), c("RECOVERY_AMOUNT", "masked", { sensitive: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      c("PIP_EMPLOYEE_COUNT", "number"), c("PAYROLL_COST", "masked", { sensitive: true }),
      c("REVENUE_RECOGNISED", "masked", { sensitive: true }), c("TOTAL_COST", "masked", { sensitive: true }),
      c("GROSS_PROFIT", "masked", { sensitive: true }), c("GROSS_MARGIN_PERCENTAGE", "masked", { sensitive: true }),
      c("EBITDA_CONTRIBUTION", "masked", { sensitive: true }), c("BUDGET_VARIANCE", "masked", { sensitive: true }),
      c("RECEIVABLE_OUTSTANDING", "masked", { sensitive: true }), c("PAYABLE_OUTSTANDING", "masked", { sensitive: true }),

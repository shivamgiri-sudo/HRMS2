...
export const BPO_MASTER_REPORTS: BpoMasterReportDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      c("PLANNED_REVENUE", "currency", { sensitive: true }), c("REVENUE_RECOGNISED", "currency", { sensitive: true }),
      ...
      c("GROSS_MARGIN_PERCENTAGE", "percentage", { sensitive: true }), c("EBITDA_CONTRIBUTION", "currency", { sensitive: true }),

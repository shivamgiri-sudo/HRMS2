...
export const ACTION_ITEM_REGISTRY: ActionItemDefinition[] = [
  ...
  },
  {
    ...
    displayName:       "Cost-centre attendance finalized — awaiting Branch Head",
    module:            "PAYROLL",
    entityType:        "cc_attendance",
    defaultAssigneeRoles: ["branch_head", "super_admin"],
    defaultPriority:   ACTION_PRIORITY.HIGH,
    defaultTtlHours:   48,
    deeplinkPattern:   "/payroll/readiness/cost-centres?ref={entityId}",
    requiresScope:     true,
  },
  {
    itemType:          "CC_ATTENDANCE_BRANCH_APPROVED",
    displayName:       "Cost-centre attendance approved by Branch Head",
    module:            "PAYROLL",
    entityType:        "cc_attendance",
    defaultAssigneeRoles: ["payroll_head", "super_admin"],
    defaultPriority:   ACTION_PRIORITY.HIGH,
  ...
  },
  {
    ...
    displayName:       "Unlock requested for an approved cost centre",
    module:            "PAYROLL",
    entityType:        "cc_attendance",
    defaultAssigneeRoles: ["payroll_head", "super_admin"],
    defaultPriority:   ACTION_PRIORITY.HIGH,

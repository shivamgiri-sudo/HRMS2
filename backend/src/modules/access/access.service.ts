...
export interface ReconciliationReport {
  ...
  roles_by_user: Record<string, string[]>;
  checked_at: string;
}

/**
 * MySQL-only RBAC report.
 * Returns all active roles grouped by user_id from the MySQL user_roles table.
 */
export async function getRbacReconciliation(): Promise<ReconciliationReport> {
  // Fetch all active MySQL user_roles
  ...
  return {
    ...
    roles_by_user: Object.fromEntries(mysqlByUser),

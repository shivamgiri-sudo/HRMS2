...
export async function importClEmailRawBatch(
  ...
  const inserted = await chunkedMasmisInsert({
    insertPrefix: `INSERT INTO db_masmis.cl_email_raw (unique_id, emp_id, week, report_date, agent_name, open_email, in_process, re_open, total_mail_assigned, total_touched_email, closed_email, junk_mail, uploaded_by, upload_batch_id)`,
    placeholderGroup: "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
    rows: toInsert,
  });

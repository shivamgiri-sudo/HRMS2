 ...
 * db_masmis.aw_new_cdr table (3 real rows, uploaded_by=7, upload_batch_id
 * populated -- inserted by the separate My Dashboards tool; confirmed no
 * existing HRMS2 code path writes here yet). Same shape as aw_inbound minus
 * caller_e164, plus sub_lob/partner/slot.
 *

...
export async function importLpFeedbackCdrBatch(
  ...
  const inserted = await chunkedMasmisInsert({
    insertPrefix: `INSERT INTO db_masmis.lp_feedback_cdr
  ...
  // chunkedMasmisInsert already marks every successfully-inserted row
  // 'imported' in upload_batch_row internally -- no need to repeat that here.

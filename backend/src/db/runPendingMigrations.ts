...
const MIGRATION_MANIFEST: string[] = [
  ...
  "1779_appreciate_chat_new_table.sql", // Registered 2026-09-24. Creates db_masmis.appreciate_chat for the new Appreciate Wealth Chat uploader (25 columns from the user-supplied header row). CREATE TABLE IF NOT EXISTS, purely additive. NOTE: the app db user has no CREATE on db_masmis, so this needs a higher-privileged run or manual grant (same as sql/1766, 1774, 1776).
  "1780_appreciate_chat_uploader.sql", // Registered 2026-09-24. Registers the upload_template_master row for AW_CHAT_MASMIS, applied ahead of the table existing (same pattern as sql/1775, 1777) -- uploads fail with table-not-found until sql/1779 is run.

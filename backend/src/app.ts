...
import { performanceIngestionRouter } from "./modules/performance-ingestion/performance-ingestion.routes.js";
import { performanceManualUploadRouter } from "./modules/performance-ingestion/performance-manual-upload.routes.js";
import { performanceGovernanceAuditRouter } from "./modules/performance-ingestion/performance-governance-audit.routes.js";
...
app.use("/api/performance-hub/ingestion", performanceIngestionRouter);
app.use("/api/performance-hub/ingestion", performanceManualUploadRouter);
app.use("/api/performance-hub/governance", performanceGovernanceAuditRouter);

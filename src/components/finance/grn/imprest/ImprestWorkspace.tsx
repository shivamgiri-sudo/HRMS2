...
/**
 * The three imprest surfaces, under one tab.
 *
 ...
 *
 * Approvals leads because it is the only one of the three with work waiting in it.
 */

type Pane = "approvals" | "allocation" | "report";

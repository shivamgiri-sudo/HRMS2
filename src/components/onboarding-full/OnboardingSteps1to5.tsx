...
function T({ label, value, onChange, required, placeholder }: {
  label: string; value: string; onChange: (v: string) => void;
...
function RO({ label, value, highlight }: { label: string; value?: any; highlight?: boolean }) {
  return (
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="shadow-md overflow-hidden border-0">
        <div className="bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-600 px-6 pt-6 pb-8">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0">
              <span className="text-2xl">👋</span>
            </div>
            <div>
              <p className="text-blue-100 text-xs font-bold uppercase tracking-widest">Welcome to</p>
              <h1 className="text-white text-xl font-black leading-tight mt-1">MAS Callnet Onboarding</h1>
    ...
    <Card className="shadow-md border-0 overflow-hidden">
      ...
      <CardContent className="pt-5 px-3 max-w-lg mx-auto w-full sm:max-w-none sm:px-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3 mt-4">
          ...
          <F label="Category / Caste" value={employee.category} onChange={(v) => upd("category", v)} opts={CATEGORIES}
            helpText="Required for statutory compliance" />
        </div>
...
export function Step3AddressKyc({
  ...
  return (
    <Card className="shadow-md border-0 overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-purple-700 to-purple-600 text-white px-5 py-4">
        <CardTitle className="text-lg flex items-center gap-2">📍 Address & KYC Details</CardTitle>
        <p className="text-sm text-purple-100 mt-0.5">Your addresses and identity documents</p>
      </CardHeader>
...
export function Step4Documents({
  ...
  return (
    <Card className="shadow-md border-0 overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-5 py-4">
...
export function Step5Bgv({
  ...
  return (
    <Card className="shadow-md border-0 overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-indigo-700 to-indigo-600 text-white px-5 py-4">
        <CardTitle className="text-lg flex items-center gap-2">
          <ShieldCheck className="h-5 w-5" /> BGV Consent & Verification
        </CardTitle>
        <p className="text-sm text-indigo-100 mt-0.5">Background verification and digital identity check</p>
      </CardHeader>
      <CardContent className="pt-5 px-4 space-y-5">
...
export function Step6Bank({
  ...
  return (
    <Card className="shadow-md border-0 overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-green-700 to-green-600 text-white px-5 py-4">
        <CardTitle className="text-lg flex items-center gap-2">🏦 Bank Account Details</CardTitle>

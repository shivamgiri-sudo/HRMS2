...
export const navGroups: NavGroup[] = [
  /* ── OVERVIEW ─────────────────────────────────────────────── */
  {
    ...
    items: [
      ...
      { label: "Reports",       href: "/reports",       icon: ic(BarChart3),     roles: ["admin","hr","manager","ceo","coo","branch_head","wfm","operations_manager","qa","quality_analyst","payroll_head","finance","recruiter"], description: "Reports" },
      { label: "My Dashboard",        href: "/my-dashboard",        icon: ic(LayoutDashboard), public: true, description: "Employee dashboard" },
      ...
      { label: "WFM Attendance",      href: "/wfm-attendance",      icon: ic(Clock),           roles: ["wfm","admin","super_admin","hr"], description: "WFM attendance detail dashboard" },
      ...
      { label: "Quality Dashboard",   href: "/quality-dashboard",   icon: ic(ShieldCheck),     roles: ["qa","quality_analyst","admin","super_admin","ceo","manager","process_manager","branch_head","operations_manager"], description: "QA role dashboard" },
      { label: "Operations Dashboard", href: "/operations-dashboard", icon: ic(Activity),      roles: ["operations_manager","admin","super_admin","ceo","manager","process_manager","branch_head"], description: "Operations role dashboard" },
      { label: "Recruiter Dashboard", href: "/recruiter-dashboard",  icon: ic(Users2),          roles: ["recruiter","hr","admin","super_admin","manager"], description: "Recruiter role dashboard" },
      { label: "IT Dashboard",        href: "/it/dashboard",         icon: ic(Server),          roles: ["it","branch_it","it_admin"], description: "IT provisioning & asset dashboard" },
    ],
  },

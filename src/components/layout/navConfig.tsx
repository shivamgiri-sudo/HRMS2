    ...
    items: [
      ...
      { label: "Departments",  href: "/departments", icon: ic(Building2),  roles: ["admin","hr","manager","ceo","coo","branch_head"], description: "Departments" },
      {
        ...
        children: [
          ...
          { label: "Meta Campaigns", href: "/ats/meta-campaigns", icon: ic(Activity), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_hr","branch_head","recruitment_hr"], description: "Meta/WhatsApp lead campaigns and outreach" },
          { label: "Meta Leads", href: "/ats/meta-leads", icon: ic(Users), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_hr","branch_head","recruitment_hr"], description: "Incoming leads from Meta campaigns" },
          { label: "WhatsApp Inbox", href: "/ats/whatsapp-inbox", icon: ic(MessageSquare), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_hr","branch_head","recruitment_hr"], description: "Candidate WhatsApp conversations from Meta campaigns" },

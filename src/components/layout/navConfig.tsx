    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Salary Disputes",  href: "/payroll/salary-disputes",   icon: ic(AlertCircle), pageCode: "SALARY_DISPUTE", description: "Raise or track salary disputes" },
        ],
      },
      {
    ...
    items: [
      ...
      { label: "Departments",  href: "/departments", icon: ic(Building2),  roles: ["admin","hr","manager","ceo","coo","branch_head"], description: "Departments" },
      {
        ...
        children: [
          ...
          { label: "Meta Campaigns", href: "/ats/meta-campaigns", icon: ic(Activity), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_admin","branch_head","branch_wfm","recruitment_hr","payroll_hr","interviewer","operations_manager","process_manager","manager","management"], description: "Meta/WhatsApp lead campaigns and outreach" },
          { label: "Meta Leads", href: "/ats/meta-leads", icon: ic(Users), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_admin","branch_head","branch_wfm","recruitment_hr","payroll_hr","interviewer","operations_manager","process_manager","manager","management"], description: "Incoming leads from Meta campaigns" },
          { label: "WhatsApp Inbox", href: "/ats/whatsapp-inbox", icon: ic(MessageSquare), pageCode: "ATS_META_CAMPAIGNS", roles: ["admin","hr","super_admin","recruiter","branch_admin","branch_head","branch_wfm","recruitment_hr","payroll_hr","interviewer","operations_manager","process_manager","manager","management"], description: "Candidate WhatsApp conversations from Meta campaigns" },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "CC Attendance",        href: "/payroll/readiness/cost-centres",   icon: ic(Building2),    roles: ["super_admin","payroll_head","branch_head","payroll_branch","admin","hr","finance","payroll","process_manager","wfm"], pageCode: "PAYROLL_BRANCH_READINESS", description: "Cost-centre attendance finalization for payroll" },
          ...
          { label: "Exception Control",    href: "/payroll/exception-control",        icon: ic(ShieldCheck),  roles: ["super_admin","admin","payroll_head","payroll_admin"],                                                  pageCode: "PAYROLL_ATTENDANCE_CONTROL_TOWER", description: "Per-employee COSEC exceptions and month-level payable days" },
          ...
          { label: "Recalculation Queue",  href: "/payroll/recalculation-queue",      icon: ic(Settings2),    roles: ["admin","super_admin","payroll_head","payroll_branch"],                                                 description: "Payroll recalculation queue" },
          ...
          { label: "TDS Certificate",      href: "/payroll/tds-certificate-part-a",   icon: ic(ShieldCheck),  roles: ["super_admin","admin","payroll_head","payroll","payroll_hr","finance"],                               description: "TRACES Part A upload & verify" },
          // ── EMPLOYEE SERVICES ────────────────────────────────────────────
          ...
          { label: "Overtime",             href: "/payroll/overtime",                 icon: ic(Clock),        roles: ["admin","super_admin","wfm","payroll","payroll_head"],                                 description: "Overtime calculation & approvals" },

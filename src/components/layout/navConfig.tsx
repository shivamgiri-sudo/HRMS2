    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Onfido Process",      href: "/process-operations?process=onfido&view=live", icon: ic(ShieldCheck), pageCode: "PROCESS_OPERATIONS", description: "Onfido DOC/POA volume, AHT, quality and escalations — in Process Operations", roles: ["super_admin","admin","ceo","coo","manager","process_manager","team_leader","branch_head","qa","quality_analyst"] },
        ],
      },
      {

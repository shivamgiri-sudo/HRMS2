    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Salary Review Queue",  href: "/payroll/salary-review",            icon: ic(ShieldCheck),  pageCode: "PAYROLL_HEAD_SALARY_REVIEW_QUEUE", roles: ["super_admin","payroll_head","admin"],                  description: "Mandatory pre-payroll salary / BGV / document / bank review" },

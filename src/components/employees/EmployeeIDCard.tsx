      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            {/* ── Photo circle ── */}
            {premium ? (
              /* Premium: conic gold shimmer ring, then photo fills PI */
              <div style={{
                ...
                <div style={{ width: PD + 2, height: PD + 2, borderRadius: "50%", background: "white", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <div style={{ width: PI, height: PI, borderRadius: "50%", overflow: "hidden", background: "#e5e7eb" }}>
                    {photoUrl
                      ? <img src={normalizeMediaUrl(photoUrl)} alt={fullName} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              ...
              /* Standard: 3px accent ring, 3px white gap, then photo fills PI */
              <div style={{

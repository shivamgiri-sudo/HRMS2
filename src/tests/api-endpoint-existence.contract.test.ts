...
const KNOWN_MISSING: Record<string, string> = {
  ...
  // ── KPI Studio ─────────────────────────────────────────────────────────────────────────────
  // Twenty-one /api/kpi-studio/* paths were listed here as "No backend module exists".
  // They did exist: the module is backend/src/modules/kpi/kpi-studio.{routes,service,

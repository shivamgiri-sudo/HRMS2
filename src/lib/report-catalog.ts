...
export const REPORT_CATALOG: ReportMeta[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "doj", label: "DOJ", format: "date", width: 110 },
      ...
      { key: "email_id", label: "Email ID", format: "text", width: 180 },
      { key: "gender", label: "Gender", format: "text", width: 80 },
      ...
      { key: "net_in_hand", label: "Inhand", format: "currency", width: 110, align: "right" },
      { key: "offered_ctc", label: "CTC", format: "currency", width: 110, align: "right" },
    ],
    viewRoles: ["super_admin", "admin", "hr", "hr_head", "manager", "process_manager", "branch_head"],
    exportRoles: ["super_admin", "admin", "hr", "hr_head"],
    defaultFilters: {
  ...
  },
  {
    ...
    category: "Attendance",
    subcategory: "Exceptions",
    description: "Full audit trail for every regularization request (plain regularizations and disputes together): actual attendance before, what it was changed to, who requested it and when, who approved it, when, and their remarks",
    rowGrain: "One row per regularization request",
    ...
    columns: [
      ...
      { key: "attendance_date", label: "Attendance Date", format: "date", width: 100 },
      { key: "dispute_type", label: "Dispute Type", format: "status", width: 120 },
      { key: "actual_attendance_status", label: "Actual Attendance (Before)", format: "status", width: 150 },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "reporting_manager", label: "Reporting Manager", format: "text", width: 160 },
      { key: "doj", label: "DOJ", format: "date", width: 110 },
      { key: "left_date", label: "LeftDate", format: "date", width: 110 },

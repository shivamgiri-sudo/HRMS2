...
export const REPORT_CATALOG: ReportMeta[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "department_name", label: "Department", format: "text", width: 120 },
      { key: "process_name", label: "Process", format: "text", width: 140 },
      { key: "cost_centre_code", label: "Cost Centre Code", format: "currency", width: 120, align: "right" },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "process_name", label: "Process", format: "text", width: 140 },
      { key: "cost_centre_code", label: "Cost Centre Code", format: "currency", width: 120, align: "right" },
      { key: "cost_centre_name", label: "Cost Centre Name", format: "currency", width: 120, align: "right" },
    ],
    viewRoles: ["super_admin", "admin", "hr", "hr_head", "manager", "process_manager", "branch_head"],
    exportRoles: ["super_admin", "admin", "hr", "hr_head"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════════
  {
    ...
    columns: [
      ...
      { key: "run_status", label: "Run Status", format: "status", width: 130 },
      { key: "employee_code", label: "Emp Code", format: "text", width: 100 },
      { key: "employee_name", label: "Employee Name", format: "text", width: 180 },
      { key: "cost_centre_code", label: "Cost Centre Code", format: "currency", width: 120, align: "right" },
      { key: "cost_centre_name", label: "Cost Centre Name", format: "currency", width: 120, align: "right" },
      ...
      { key: "line_status", label: "Line Status", format: "status", width: 130 },
      { key: "net_mismatch_amount", label: "Net Mismatch Amount", format: "currency", width: 120, align: "right" },
      { key: "payroll_risk", label: "Payroll Risk", format: "text", width: 150 },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "cost_centre_name", label: "Cost Centre", format: "text", width: 180 },
      { key: "department_name", label: "Department Name", format: "text", width: 150 },
      { key: "designation_name", label: "Designation Name", format: "text", width: 150 },
      { key: "pan_number", label: "PAN Number", format: "masked", width: 120 },
      { key: "uan_number", label: "UAN Number", format: "text", width: 150 },
      { key: "bank_account_number", label: "Bank Account Number", format: "masked", width: 120 },
      { key: "basic_pay", label: "Basic Pay", format: "number", width: 100, align: "right" },
      { key: "hra", label: "HRA", format: "currency", width: 100, align: "right" },
      { key: "special_allowance", label: "Special Allowance", format: "number", width: 100, align: "right" },
      { key: "other_allowances", label: "Other Allowances", format: "number", width: 100, align: "right" },
      { key: "gross_salary", label: "Gross Salary", format: "currency", width: 120, align: "right" },
      { key: "pf_employee", label: "PF Employee", format: "number", width: 100, align: "right" },
      { key: "esic_employee", label: "ESIC Employee", format: "number", width: 100, align: "right" },
      { key: "professional_tax", label: "Professional Tax", format: "currency", width: 120, align: "right" },
      ...
      { key: "payable_days", label: "Payable Days", format: "currency", width: 120, align: "right" },
      { key: "lwp_days", label: "LWP Days", format: "number", width: 100, align: "right" },

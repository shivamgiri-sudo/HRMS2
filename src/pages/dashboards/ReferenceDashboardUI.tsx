  ...
  return (
    <Link to={href} className="reference-quick-link" aria-label={title}>
      ...
      <span className="min-w-0 flex-1">
        <span className="block truncate text-[11px] font-semibold text-[#1d2b45]">{title}</span>
        {subtitle ? <span className="mt-0.5 block truncate text-[9px] text-[#71809a]">{subtitle}</span> : null}
      </span>

...
const DEFAULT_CONFIG: Config = {
  ...
  vocOptions: ["Undergraduate / Qualification Issue", "Poor Communication Skill", "Poor Reading / Comprehension", "Salary Issue", "Shift / Timing Issue", "Location / Travel Issue", "Stability Concern", "Documentation Issue", "Role / Process Mismatch", "Candidate Not Interested", "No Show", "Age Barrier", "Sales Skills Not Up to the Mark", "Not Comfortable in Sales", "Underconfident / Nervous", "MTI Issue", "Not Fit for the Process"],

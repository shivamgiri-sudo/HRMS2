...
import {
  ...
  Edit2, FileText, History, Info, Loader, Plus,
...
interface FilingRecord {
  id: string;
  filing_month: string;
  filing_type: "EPF" | "ESIC" | "TDS_24Q" | "LWF";
...
const TYPE_ORDER = ["EPF", "ESIC", "TDS_24Q", "LWF"] as const;
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-violet-200 text-sm mt-0.5">EPF · ESIC · TDS · LWF — unified compliance control</p>
              </div>
            </div>

    ...
    <DashboardLayout>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 md:grid-cols-3 xl:grid-cols-6">
          ...
          <MetricCard label="Walk-ins" value={dashboardFailed ? "—" : formatMetric(dashboardMetrics?.walkins ?? 0)} sub={`${dashboardRate("walkin_rate")}% of shortlisted`} icon={<Users className="h-4 w-4" />} unavailable={dashboardFailed} />
